...
Welcome to website and mobile application (hereinafter jointly, the “**App**”)! This App is operated by Trevo as defined below (“**Trevo**”). These Terms and Conditions is the binding legal agreement between Trevo and you, the user of our App, and Services as defined below.
...
Trevo reserves the right, at its sole discretion, to change these Terms. These changes are effective immediately upon posting the amended Terms on the App, unless otherwise stated. When changes come into effect, the revised Terms shall supersede the previous version of the Terms. You are responsible for regularly reviewing these Terms. 

1. **Definitions**

   1. “**Trevo**” means an Exempt Private Company Limited by Shares, duly incorporated in Singapore, having its registered address at 10 Anson Road, #20-05, International Plaza, Singapore (079903).
   2. “**Services**” means Trevo’s services on maintaining and hosting the App and Software, making available services accessible through it.
   3. “**Terms**” means these Terms and Conditions as amended from time to time.
   4. “**User**” means any entity accessing or using the Service and App.
...
2. **Disclaimer**
   ...
   2. You should carefully consider all possible risks, and you shall be free to make your own decision 
...
4. **Restricted Countries**
   ...
   1. You should be aware that our App may be restricted and/or unavailable for users in some jurisdictions as governed by applicable laws. Trevo shall not be responsible for any unavailability of our App and/or Services in any Restricted Country or other countries. 
   2. You should personally ensure that using our Services is allowed in your country of citizenship or residence. Trevo shall not be responsible for any violation of laws pertaining to the above.
   3. Trevo shall not be held liable for any use of our Services by individuals or legal entities that are restricted or limited to use our Services. Users who violate their applicable laws and regulations shall be solely liable for such violation.
...
2) Unless otherwise indicated under the Clause 5.1 above, all intellectual property rights (such as but not limited to trademarks, trade names, logos, patents, copyrights, domain names and derivative rights) in the Services and related content and technology around the world are and will remain the exclusive property of Trevo or its licensors. 
...
6. **Wallet**
   ...
   1. Trevo provides a non-custodial wallet software for digital assets issued on Trevo blockchain. The Users can use the wallet to authorize transactions and pay for the Services. The Users shall be solely responsible for:

- any activities and risks associated with their wallet;
- retention and security of their private key to access the wallet.

2. Keeping your private key securely is important, otherwise you may lose control of your wallet. Trevo does not store or have access to your private key and cannot retrieve it in case of loss. The private keys are stored at User’s device only. Trevo shall have no responsibility or liability whatsoever in the event you are unable to access your wallet for any reason or lose your tokens. The User shall be solely responsible for saving backup keys, and use the App at its sole risk. 
...
4. reproduce, duplicate, copy, sell, resell or exploit any portion of the Service, use of the Service, or access to the Service without the express written permission by Trevo;
...
7. violate third party rights, including, without limitation, Trevo’s agents, partners, on the App and/or cause harm in any way;
...
18) **Miscellaneous**
    ...
    3. No joint venture, partnership, employment, or agency relationship exists between you and Trevo as a result of these Terms.
    ...
    5. Trevo reserves the right to assign its obligations and duties in these Terms to any person or entity.
    6. Any notice or other communication to be given to us under these Terms shall be in writing in the English language unless otherwise agreed between Trevo and the user. Any notice or other communication from users shall take effect only when received by us unless such notice or another communication is contrary to these Terms.
    7. These Terms constitute the entire agreement between you and Trevo with respect to your use of the App, use of the Products and Services. For issues related to any of the above, the User agrees to rely only on these Terms with respect to the subject matter hereof. 
...
19) **Contact Us**
    ...
    1. If you have questions in relation to these Terms, please contact us at <support@trevo.finance>. Trevo Ltd., Republic of Singapore.
    2. © Copyright 2023 Trevo Pte. Ltd. All Rights Reserved.
