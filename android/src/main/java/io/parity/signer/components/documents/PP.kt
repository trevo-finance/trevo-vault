...
Trevo LTD. (“**Trevo**”, “**we**”, “**our**”, “**us**”) receives, collects, stores, and manages user personal data according to the following Privacy Policy. We take pride in treating our users’ privacy the way we would like to be treated ourselves. We make sure we comply with the applicable personal data protection laws and regulations. 

By visiting our website https\://trevo.finance/ (“**Website**”), and/or sharing any personal information as described below, and/or using any of Trevo’s products and services (the “**Services**”), you agree to the terms of this Privacy Policy. 
...
1.5.1 Apart from cookies, we use other similar technologies, like web beacons, to monitor traffic, deliver and communicate with cookies, improve site performance. Similar to cookies you may opt out from web beacons at any time. If you wish to opt out of this processing activity, please contact us at support\@trevo.finance with the subject named “Privacy Policy”. 
...
3.1.3 to analyze and improve Trevo Services; 
...
4.2 Trevo is operated from the USA. If you are visiting the Website or Services from outside of Singapore, you agree to any processing of any personal information you provide us according to this policy. 
...
4.4 Only aggregated, anonymized data is periodically transmitted to external services to help us improve the Website and Services. To receive the current list of external services that we use for this purpose, please email at support\@trevo.finance. 
...
6.2 If you request us to view, change and remove your data associated with your account, please contact us at trevo\@trevo.finance. We will process your request within 15 business days. In accordance with the applicable laws, additional fees may be applied. 
...
10.1 Should you have any questions or concerns, please email us at support\@trevo.finance.
						""".toRichTextStr()
	)
}
